...
- 当前进行中的 docs/design 阶段：`PHASE_17A_RECIPE_FIRST_RUNTIME_INTEGRATION_DESIGN_FREEZE`（branch `feature/recipe-first-runtime-integration-design`；docs/design only）。
