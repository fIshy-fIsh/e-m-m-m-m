...
- **Frozen contracts:** `D-ENUM-001..004`, `D-CACHE-001..004`, `D-BUDGET-001`, `D-ACCOUNTING-001`, `D-SCANNER-001`, `D-VALIDATION-001`, `D-MEMORY-001`, `D-ADAPTER-003`, `D-ADAPTER-004` are preserved unchanged. `D-CACHE-001` has been superseded for its original run-reuse + CLI composition gap after Phase 14B / 14C / 14D landed; deferred write/refresh concerns remain separate future work. `D-PHASE14A-R1-COHERENCE` records the design coherence corrections.
