...
- **Phase:** `PHASE_14C_COMPLETE`. Phase 14B implemented run-scoped exact-name reuse and NEW-LIVE accounting. Phase 14C integrates optional Phase12D FRESH_ONLY cache READ at the scanner service/session boundary; default CLI runtime composition remains Phase 14D.
