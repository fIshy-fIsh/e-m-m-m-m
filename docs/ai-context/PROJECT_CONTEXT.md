...
- **Latest completed phases:**
  - **Phase 13S** — structural coverage allocation + recipe-depth universe (`COHORT_DEPTH_IMPLEMENTED_NO_RECIPE_GAIN`; BREADTH preserved as default, opt-in 4/3/3 cohort-depth live verified under the same 10-goods bound; one recipe, delta 0).
