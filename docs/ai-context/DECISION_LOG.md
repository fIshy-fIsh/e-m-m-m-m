...
- **Future revisit:** any future Phase 14 implementation must respect the corrected design; Phase 14B / 14C may amend individual sub-decisions under explicit reviewed authorization. R1 is NOT a license to start Phase 14B implementation — Phase 14B remains PROPOSED / NOT AUTHORIZED UNTIL R1 REVIEW.
